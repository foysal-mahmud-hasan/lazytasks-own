...
import { AboutModal } from "../HeaderElement/AboutModal";
import { fatchLazytasksConfig } from "./store/settingSlice";
import FluentFormIframe from "../HeaderElement/FluentFormIframe";
        ...
        <Fragment>
            <Grid>
                {appLocalizer.premiumInstalled === '' && window.appLocalizerPremium === undefined &&
                    <Title className={`text-center w-full`} order={4} >
                        {translate('How to download and connect “LazyTasks” mobile app with installed plugin')}
                    </Title>
                }
                ...
                {appLocalizer.premiumInstalled !== '' && window.appLocalizerPremium &&
                    <Title className={`text-center w-full`} order={4} >
                        {translate('How to connect “LazyTasks” mobile app with installed plugin')}
                    </Title>
                }
                {appLocalizer.premiumInstalled !== '' && window.appLocalizerPremium &&
                    <Grid.Col span={12} mb="sm">
